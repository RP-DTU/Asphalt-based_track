...
% Stress throughout the middel of the sleeper in the direction of the length
    ...
    title({['Stress along the middle of the sleeper in length direction'] ['E=' num2str(E(h)) 'MPa, t =' num2str(t) 'mm and c =' num2str(c)]});
    xlabel('Length [mm]');
    ylabel('Stress [kPa]');
    grid on
...
% Stress throughout the edge of the sleeper in the direction of the length
    ...
    title({'Stress along the edge of the sleeper in length direction', ['E=' num2str(E(h)) 'MPa, t =' num2str(t) 'mm and c =' num2str(c)]});
    xlabel('Length [mm]');
    ylabel('Stress [kPa]');
    grid on
    lgd = legend(string(k),'location','northeast');
...
% Stress throughout the middel of the sleeper in the direction of the width
    ...
    title({'Stress along the middle of the sleeper in width direction', ['E=' num2str(E(h)) 'MPa, t =' num2str(t) 'mm and c =' num2str(c)]});
    xlabel('Width [mm]');
    ylabel('Stress [kPa]');
    grid on
    lgd = legend(string(k),'location','northeast');
...
% Stress throughout the edge of the sleeper in the direction of the width
    ...
    title({'Stress along the edge of the sleeper in width direction', ['E=' num2str(E(h)) 'MPa, t =' num2str(t) 'mm and c =' num2str(c)]});
    xlabel('Width [mm]');
    ylabel('Stress [kPa]');
    grid on
    lgd = legend(string(k),'location','northeast');

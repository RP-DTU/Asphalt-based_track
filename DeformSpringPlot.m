...
for i = 1:length(k)
    ...
    title({['Compression of spring-bed'] ['E=' num2str(E(h)) 'MPa, t =' num2str(t) 'mm, k_0=' num2str(k(i)) 'kPa/mm and c=' num2str(c)]});
    xlabel('Length [mm]');
    ylabel('Width [mm]');
    ...
    colorbar
    title({'Heatmap of spring-bed compression [mm]', ['E=' num2str(E(h)) 'MPa, t =' num2str(t) 'mm, k_0=' num2str(k(i)) 'kPa/mm and c=' num2str(c)]});
    xlabel('Length [mm]');
    ylabel('Width [mm]');
    if W == 300
    pbaspect([4 1 1]);
    ...
    title({['Compression of the spring-bed']  ['along the middle of the sleeper in lenght direction'] ['E=' num2str(E(h)) 'MPa, t =' num2str(t) 'mm and c=' num2str(c)]});
    xlabel('Length [mm]');
...
% Deformation throughout the edge of the sleeper in the direction of the length
    ...
    title({['Compression of the spring-bed'] ['along the edge of the sleeper in length direction'] ['E=' num2str(E(h)) 'MPa, t =' num2str(t) 'mm and c=' num2str(c)]} );
    xlabel('Length [mm]' );
    ylabel('Compression [mm]' );
    grid on
    lgd = legend(string(k),'location','northeast' );
...
% Deformation throughout the middel of the sleeper in the direction of the width
    ...
    title({['Compression of the spring-bed']  ['along the middle of the sleeper in width direction'] ['E=' num2str(E(h)) 'MPa, t =' num2str(t) 'mm and c=' num2str(c)]} );
    xlabel('Width [mm]' );
    ylabel('Compression [mm]' );
    grid on
    lgd = legend(string(k),'location','northeast' );
...
%Deformation throughout the edge of the sleeper in the direction of the width
    ...
    title({['Compression of the spring-bed']  ['along the edge of the sleeper in width direction'] ['E=' num2str(E(h)) 'MPa, t =' num2str(t) 'mm and c=' num2str(c)]} );
    xlabel('Width [mm]' );
    ylabel('Compression [mm]' );
    grid on
    lgd = legend(string(k),'location','northeast' );
